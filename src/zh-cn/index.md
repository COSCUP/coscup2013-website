<div><!--add root div as a workaround of weird makrdown parser-->
  <div id="left">
    ...
    <div class="whatiscoscup">
      <h1>COSCUP 2013</h1>
      <div class="text">开源(Open Source)的三大支柱是开发者、使用者与推广者。开发者（大神）是主要的生产者，但同时也是其它程序的使用者。在使用者了解 FLOSS 文化、熟练技能之后，也将成为下一代的开发者或推广者。推广者是扩大使用者数目的的重要媒介，也是 COSCUP 最想扮演的角色。 
